...
namespace ODL.DataAccess.Migrations
{
    ...
    public partial class Initial : CustomMigrations
    {
                ...
                c => new
                    {
                        ...
                        EpostAdress = c.String(nullable: false, maxLength: 255, unicode: false),
                    })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("Adress.Epost", "AdressFKId", "Adress.Adress");
            ...
            DropIndex("Adress.Epost", new[] { "AdressFKId" });
